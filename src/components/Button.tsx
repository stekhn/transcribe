...
export const Button: React.FC<ButtonProps> = ({
    ...
    const buttonStyle = clsx(
        "inline-flex items-center text-sm justify-center font-medium whitespace-nowrap rounded-lg transition-colors duration-300 focus:outline-none focus:ring-2 gap-1 px-4 py-2",
        {
